...
hcgendf <- hcgen %>% select(-city, -address,  -county_name, -hospital_overall_rating_footnote, -safety_of_care_national_comparison_footnote, -mortality_national_comparison_footnote, -readmission_national_comparison_footnote, -patient_experience_national_comparison_footnote, -effectiveness_of_care_national_comparison_footnote, -timeliness_of_care_national_comparison_footnote, -efficient_use_of_medical_imaging_national_comparison_footnote, -location, -zip_code, -phone_number)
...
hcgendf <- hcgendf %>% mutate(effectiveness_of_care_national_comparison = as.factor(effectiveness_of_care_national_comparison), efficient_use_of_medical_imaging_national_comparison = as.factor(efficient_use_of_medical_imaging_national_comparison), hospital_overall_rating = as.numeric(hospital_overall_rating), hospital_ownership = as.factor(hospital_ownership), hospital_type = as.factor(hospital_type), mortality_national_comparison = as.factor(mortality_national_comparison), patient_experience_national_comparison = as.factor(patient_experience_national_comparison), readmission_national_comparison = as.factor(readmission_national_comparison), safety_of_care_national_comparison = as.factor(safety_of_care_national_comparison), state = as.factor(state), timeliness_of_care_national_comparison = as.factor(timeliness_of_care_national_comparison), emergency_services = as.factor(emergency_services), meets_criteria_for_meaningful_use_of_eh_rs = as.factor(meets_criteria_for_meaningful_use_of_eh_rs))
